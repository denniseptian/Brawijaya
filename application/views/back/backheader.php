            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <a href="#"><span class="fa fa-file-text-o"></span> <span class="xn-text">Pages</span></a>
                        <ul>
                            <li>
                        <a href="<?php echo site_url('admin/newpost'); ?>"><span class="fa fa-file-text-o"></span> <span class="xn-text">New Post</span></a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('admin/postlist'); ?>"><span class="fa fa-file-text-o"></span> <span class="xn-text">Post list</span></a>
                    </li>  
                        </ul>
                    </li>              
                    <li class="xn-openable">
