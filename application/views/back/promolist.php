              ...
              if ($data_get == NULL) {
                ...
                foreach ($data_get as $row) {
                  ...
                  <tr>
                    ...
                    <td><?php echo $row->promolimitdate ?></td>
                    <td><?php echo $row->date; ?></td>
                    <td>
                      <a href="<?php echo site_url('outputfiles/pdf'); ?>" class=" btn btn-xs"><span class="fa fa-file-pdf-o" aria-hidden="true"></span></a>
                    </td>
                    <td align="center">
                      <a href="<?php echo site_url('promo/edit/' . $row->id_promo); ?>" class="btn-warning btn-xs" ><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                      <a onClick="return confirm('Anda yakin ingin menghapus data ini?')" href="<?php echo site_url('promo/delete/' . $row->id_promo); ?>" class="btn-control btn-danger btn-xs"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                    </td>
                  </tr>
                  <?php
                }
