      ...
      <div class="panel-body">
        <table class="table datatable">
          ...
          <tbody>
            ...
            if ($data_get == NULL) {
              ?>
              <div class="alert alert-info" role="alert">Data pesan penting kosong!</div>
              <?php
            } else {
              $nomor = 0;
              foreach ($data_get as $row) {
                ...
                <tr>
                  ...
                  <td align="center">
                    <a href="<?php echo site_url('contact/unstarmessage/'.$row->id_contact); ?>" class=" btn btn-xs"><span class="fa fa-star-o" aria-hidden="true"></span></a>
                  </td>
                </tr>
                <?php
              }
